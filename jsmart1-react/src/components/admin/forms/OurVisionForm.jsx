...
const OurVisionForm = ({ initialData, onSubmit }) => {
  ...
  useEffect(() => {
    if (initialData) {
      setTitle(initialData.title || 'Our Vision');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Our Vision section saved successfully!');

      setLoading(false);
    } catch (err) {
      console.error('Error saving vision section:', err);
      setError('Failed to save vision section. Please try again.');
      setSuccess(null);
      setLoading(false);
    }
  };
  ...
  return (
    <div className="specialized-form our-vision-form">
      {error && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            rows="10"
            placeholder="Enter your church's vision statement and details..."
            required
          />
        ...
        <div className="form-group">
          ...
          <div className="image-upload-container">
            ...
            <div className="upload-controls">
              ...
              />
              <label htmlFor="vision-image" className="btn btn-secondary">
        ...
        <div className="form-actions">
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? (
              ...
              <>
                <FontAwesomeIcon icon="save" /> Save Our Vision
              </>
            )}
          </button>
        </div>
