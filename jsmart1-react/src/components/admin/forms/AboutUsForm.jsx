...
const AboutUsForm = ({ initialData, onSubmit }) => {
  ...
  useEffect(() => {
    if (initialData) {
      setTitle(initialData.title || 'About Us');
  ...
  return (
    <div className="specialized-form about-us-form">
      {error && (
        ...
        <div className="form-group">
          ...
          <div className="image-upload-container">
            ...
            <div className="upload-controls">
              ...
              />
              <label htmlFor="about-image" className="btn btn-secondary">
        ...
        <div className="form-actions">
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? (
              ...
              <>
                <FontAwesomeIcon icon="save" /> Save About Section
              </>
            )}
          </button>
        </div>
